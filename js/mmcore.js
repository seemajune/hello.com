// dynamic mmcore.domain
// david.bielik@maxymiser.com
//$Rev: 54685 $
//<![CDATA[
if(!window.mmcore){
    window.mmcore={
    domain:(function(){var d=window.location.hostname.split('.');d.pop();d.pop();return ((d.length)?d.join('.'):'demo')+'.com';})(),
    server:'cg-demo.maxymiser.org/demo/',
    cookie_domain:'.maxymised.com',
    tpixel:false,
    cprefix:'mmcore.',
    inline_state:true,
...
//transport
    ...
    _rt:1000,
//private
    jsver:'5.16',_vars:{fv:{},act:{},uat:{},ids:{}},_act_id:0,_vars_alias:{act:'uv'},_renderers:{},_extensions:{},_r_mbs:{},
    ...
    _Init:function(first){
        ...
        if(window.sessionStorage&&_t._ShouldRunVcb()){vcb_url=_t.GetCookie('mmVcbInitScriptUrl',1);
